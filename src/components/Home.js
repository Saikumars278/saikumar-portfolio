      ...
      <div className="container home-container">
        <div className="row align-items-center">
          ...
          <div className="col-md-6 text-start">
            ...
            <h4 className="mt-3 text-secondary" style={{ fontSize: '1.75rem' }}>
              Python Full Stack Developer
            </h4>

            <p className="mt-3" style={{ fontSize: '1.15rem', lineHeight: '1.8' }}>
            ...
            <div className="mt-4">
              <a href="#projects" className="btn btn-primary me-3 px-4 py-2 fs-5">
                View My Work
              </a>
          ...
          {/* Right Logo: visible only on md (≥768px) and above */}
